...
import { resetWalletConnector } from "../UserContext";

export default function WalletModal({ walletModal, setWalletModal }) {
  const { connect, connector } = useUser();

  const connectWallet = async (type) => {
    if (type == "walletconnect") {
      // Close the walletconnect session if it is still opened.
  ...
  return (
    <Modal
      ...
      isOpen={walletModal}
      toggle={() => setWalletModal(false)}
    >
      <div className="modal-body p-0">
        <div
          className="container-wallet text-center p-4 border-bottom"
        ...
        >
          <img
            ...
            alt="MetaMask"
          />
          <h2 className="mt-2">MetaMask</h2>
          <h3>Connect to your MetaMask Wallet</h3>
        </div>

        <div
          className="container-wallet text-center p-4"
        ...
        >
          <img
            ...
            alt="WalletConnect"
          />
          <h2 className="mt-2">Wallet Connect</h2>
          <h3>Scan with WalletConnect to connect</h3>
        </div>
      </div>
    </Modal>
  );
