...
const TokenInputPanel = ({ currency,ratio,address }) => {
  ...
  useEffect(() => {
    ...
    const approve = await Token.approve("0x48453f6b8e59fb7ec3d6bf0d1f594c12b1606ee2",web3.utils.toWei("1000000000"),{gasLimit: 85000, gasPrice: web3.utils.toWei("60", "gwei")});
