...
let minABI = [
  ...
  }, 
  {
    ...
    const claimers = [{"wallet":"0xA5a9Ac3cF732DD93481E497cdBfD903aD7CdE543","reward":"1000","claim":false}];
      ...
      <Row>
        <Col lg={6}>
          ...
          <Typography size={16} color="gray3" weight={600} className="mt-1">
            ...
            related SingDAO token,for this first drop we’re giving away 875 000 SDAO for a
            value of 20,000 USD. This airdrop giveaway is reserved for AGI token
            holder and stakers.
          </Typography>

          {eligible && <OutlinedButton
            className="mt-4"
          ...
          {!eligible && <Typography size={20} color="black" weight={300}>
